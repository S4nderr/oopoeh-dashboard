...
The state OOPOEH shows on a result card: Gematcht, Heeft aanvraag lopen, Tijdelijk geen oppas nodig, or Beschikbaar (our name for a card with no badge). Never a reason to exclude a kandidaat — only to inform.
...
**Nieuw**:
A kandidaat first observed within the last 7 days, badged as such on the dashboard.
